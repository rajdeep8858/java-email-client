# java-email-clientjava-email-client
...
Scope
This Application named alpha mail will be used to send and receive messages and attachments offline i.e. without the use of any browser.
Unlike the other mail servers this Application can be used for the other users who are not registered in the alpha mail.
Even if user lacks internet connection then also sending mails is possible.
